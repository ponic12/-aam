...
LogoPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-logo',template:/*ion-inline-start:"/home/ubuntu/workspace/pypaam/src/pages/logo/logo.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Bienvenido</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding style="background:white;text-align:center">\n  <img src="/assets/images/abracadabra.jpg" style="width:50%" >\n</ion-content>\n'/*ion-inline-end:"/home/ubuntu/workspace/pypaam/src/pages/logo/logo.html"*/,
    }),
...
ResumenPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-resumen',template:/*ion-inline-start:"/home/ubuntu/workspace/pypaam/src/pages/resumen/resumen.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Resumenes de cuenta</ion-title>\n    <img src="/assets/images/logo.jpg" class="logo" >\n  </ion-navbar>\n    \n  <ion-item>        \n    <ion-label> <ion-icon name="search"></ion-icon></ion-label>\n    <ion-input clearInput type="text" [(ngModel)]="criteria" clearInput placeholder="Buscar cliente"  required></ion-input>\n  </ion-item>\n\n</ion-header>\n\n<ion-content class="bkg" >\n  <ion-grid class="gridInfo" >\n    <ion-row class class="rowHeader">\n      <ion-col col-6 (click)="sortByName()">Nombre</ion-col>\n    </ion-row> \n    <ion-row *ngFor="let cli of clients$ | async | filterAgenda:criteria" \n      class="rowInfo"\n      (click)="openMovements($event,cli)"\n      [style.background]="(cli.balance >=0) ? \n      \'linear-gradient(to bottom, #ded 0%, #ded 88%, #cdc 100%)\':\n      \'linear-gradient(to bottom, #edd 0%, #edd 88%, #dcc 100%)\'">\n      <ion-col col-6 >{{cli.fullName}}</ion-col>\n    </ion-row>\n  </ion-grid>  \n</ion-content>\n\n\n\n'/*ion-inline-end:"/home/ubuntu/workspace/pypaam/src/pages/resumen/resumen.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* ModalController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
...
StockPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-stock',template:/*ion-inline-start:"/home/ubuntu/workspace/pypaam/src/pages/stock/stock.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Stock</ion-title>\n    <img src="/assets/images/logo.jpg" class="logo" >\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  \n</ion-content>\n'/*ion-inline-end:"/home/ubuntu/workspace/pypaam/src/pages/stock/stock.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]])
], StockPage);
